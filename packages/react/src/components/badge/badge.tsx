...
const sizeVariants: Record<BadgeSize, string> = {
  lg: 'gap-1 py-1 pl-1.5 has-[>svg]:pr-2.5 pr-1.5 [&_svg]:size-4 text-sm tracking-[-0.1px] data-[shape="rounded"]:rounded-[8px]',
  md: 'gap-1 py-0.5 pl-1 has-[>svg]:pr-2 pr-1 [&_svg]:size-4 text-sm tracking-[-0.1px] data-[shape="rounded"]:rounded-[8px]',
  sm: 'gap-[3px] py-0.5 pl-[3px] has-[>svg]:pr-1.5 pr-0.5 [&_svg]:size-3.5 text-xs data-[shape="rounded"]:rounded-[6px]',
  xs: 'gap-0.5 py-0 pl-0.5 has-[>svg]:pr-1 pr-0.5 [&_svg]:size-3 text-xs data-[shape="rounded"]:rounded-[4px]',
};
...
function Badge({
  ...
  return (
    <span
      ...
      className={cn(
        'inline-flex items-center w-fit font-medium relative [&_svg]:m-px data-[disabled="true"]:cursor-not-allowed',
        ...
        "bg-[--color-bg] text-[--color-text] [&_svg]:bg-[--color-text] data-[disabled='true']:bg-[--color-bg-disabled] data-[disabled='true']:text-[--color-text-disabled] [&_svg]:data-[disabled='true']:bg-[--color-text-disabled]",
        sizeVariants[size],
        colorVariants[color],
        className
      )}
