const _classes = {
  ...
  ProductsSelectorItemDescription:
    "nav-dropdown-products-selector-item-description",
  ...
  CodeSnippetFeedbackFormSubmitButton:
    "code-snippet-feedback-form-submit-button",
