...
const NoteIcon = ({
  ...
  return (
    <svg
      aria-label={ariaLabel}
      className={cn("size-4 text-blue-800 dark:text-blue-300", className)}
      fill="currentColor"
      height="14"
      role="img"
      viewBox="0 0 14 14"
...
const Folder2Icon = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      aria-hidden="true"
      className={className}
...
const Folder2OpenIcon = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      aria-hidden="true"
      className={className}
