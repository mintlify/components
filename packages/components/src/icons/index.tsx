...
export const DangerIcon = ({ ariaLabel = 'Danger' }: { ariaLabel?: string }) => {
  return (
    <svg
      ...
      width="14"
      fill="currentColor"
      className="flex-none w-4 h-4 text-red-600 dark:text-red-400/80"
      aria-label={ariaLabel}
    >
...
// pass in ariaLabel from useSelectedLocale['aria.check']
export const CheckIcon = ({
  ...
  return (
    <svg
      className={cn('text-green-600 dark:text-green-400/80 w-3.5 h-auto', className)}
      fill="currentColor"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 448 512"
