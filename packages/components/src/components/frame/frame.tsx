    ...
    <div className={className} data-component-part="frame-container">
      {title && (
        <div className="not-prose mb-4 flex items-center space-x-2">
          <svg
            aria-hidden="true"
            className="size-4 flex-none fill-stone-400 dark:fill-stone-300"
            viewBox="0 0 512 512"
      ...
      >
        <div
          aria-hidden="true"
          className="mask-[linear-gradient(0deg,#fff,rgba(255,255,255,0.6))] dark:mask-[linear-gradient(0deg,rgba(255,255,255,0.1),rgba(255,255,255,0.5))] absolute inset-0 bg-grid-stone-200/20 dark:bg-grid-white/5"
          data-component-part="frame-background-pattern"
          style={{ backgroundPosition: "10px 10px" }}
        />
        <div
          className="relative flex w-full justify-center overflow-hidden rounded-xl bg-white dark:bg-stone-800"
        ...
        {description && (
          <div
            className="relative mt-3 flex w-full justify-center rounded-2xl bg-white px-8 pt-0 pb-2 text-sm text-stone-700 dark:bg-stone-800 dark:text-stone-400"
