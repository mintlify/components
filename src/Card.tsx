...
export function Card({
  ...
  return (
    <Tag
      className={clsx(
        "block not-prose font-normal group relative my-2 ring-2 ring-transparent rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden px-5 py-5 w-full",
        href && "cursor-pointer",
        className
      )}
      href={href}
