    ...
    <CalloutTemplate
      ...
      icon={
        <svg
          ...
          className="flex-none w-5 h-5 text-slate-400 dark:text-slate-300"
          aria-label="Info"
        >
...
export function Warning({ children }: CalloutContent) {
  return (
    <CalloutTemplate
      icon={
        <svg
          className="flex-none w-5 h-5 text-yellow-400 dark:text-yellow-300/80"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={2}
      ...
      className="bg-amber-50 dark:bg-yellow-500/40"
    >
      {children}
    </CalloutTemplate>
  );
...
export function Tip({ children }: CalloutContent) {
  return (
    <CalloutTemplate
      ...
      className="bg-green-100/80 dark:bg-green-900"
    >
      {children}
    </CalloutTemplate>
  );
